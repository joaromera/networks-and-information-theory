...
\begin{itemize}
\item Modificar el rango de TTLs a 1-30 porque es el default que usan otras implementaciones de \textit{traceroute} y se vió que se llegó a todas las universidades con este rango.
...
Con el fin de obtener distintas salidas cada alumno corrió el script en un horario distinto. Estos son:

\begin{itemize}
\item[1] Sábado a la 1 PM.
\item[2] TODO
\item[3] TODO
\item[4] TODO
\end{itemize}