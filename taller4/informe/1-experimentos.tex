...
En una primera instancia no se consiguieron universidades que dispongan de un registro MX, para disponer de ejemplos que sí lo incluyan se escribió otro script para encontrarlos mediante una lista de sitios de universidades. Sobre estos se eligieron cuatro para realizar los experimentos. A cada uno de estos se los corrió comenzando con los root-servers a, b y c.
