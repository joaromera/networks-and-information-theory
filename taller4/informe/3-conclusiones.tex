...
\begin{itemize}
  ...
  \item ¿Todos los servidores DNS Autoritativos que aparecen en las sucesivas respuestas responden a las consultas realizadas?
  ...
  \begin{itemize}
    \item interesante el caso de la Universidad de Tübingen, para la
  ...
  \item \#fixme: para las universidades argentias, se puede intentar
    responder si crearon la web antes o después de que exista la Red
    de Interconexión Universitaria. En 1997 se crea la RIU
