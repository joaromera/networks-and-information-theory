...
Cada uno de los integrantes del grupo realizó corridas del script en los dos momentos del día previamente señalados.

\subsection{Explicación de las redes}

En el cuadro \ref{table:caracteristicas_redes} se detalla la red de cada uno de los integrantes. Todas estas estan conectadas via WI-FI.
...
\begin{tabular}{| c | c | c | c | c | c | c | c |}
  ...
  \hline  
\end{tabular}
\captionof{table}{Características de las redes utilizadas.}
