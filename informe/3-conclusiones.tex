...
Por otro lado, pudimos observar que en la mayoría de los casos la cantidad de tráfico \textit{Broadcast} es insignificante respecto a \textit{Unicast}, rara vez superando el 2\%. Únicamente en la red 4 el porcentaje de \textit{Broadcast} se acerco al 10\%, pero se dispone de pocas muestras y la topología de la red es similar a las 1 y 2, con resultados diferentes. Por esto no podemos extraer más conclusiones que la preponderancia del tráfico \textit{Unicast} en las redes hogareñas. Particularmente el protocolo que tuvo mayor incidencia en los datos fue el 2048 (IPv4), teniendo más del 90\% del total.

Finalmente consideramos que los experimentos realizados son suficientes para afirmar que en las topologías de redes hogareñas predomina el tráfico de paquetes \textit{Unicast}, con un bajo nivel de entropía y que los protocolos de los mismos se encuentra reducido a un conjunto pequeño con dominio de los paquetes de datos de usuario.