...
En la tabla \ref{table:proporcion_unicast_y_broadcast} se muestra el porcentaje de tráfico Broadcast/Unicast sobre el tráfico total.
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c | c c | c c|}
     ...
     Red & Unicast & Broadcast & Unicast & Broadcast \\
    \hline
    ...
    \hline
     Promedio & 0.98067 & 0.01933 & 0.99265 & 0.00735 \\
    \hline
    \end{tabular}
    \captionof{table}{Porcentaje de cada tipo de paquete en cada corrida.}
    \label{table:proporcion_unicast_y_broadcast}
\end{table}

Como puede verse en \ref{table:proporcion_unicast_y_broadcast}, en todas las redes hubo una fuerte preponderancia de tráfico Unicast respecto a Broadcast \textbf{(fixme: agregar el porcentaje de Uni vs Broad, haciendo promedio entre todas las redes en todos los experimentos que pongamos en el informe)}. Este resultado se mantiene en todas las redes y en ambos momentos del día en los que ocurrieron los experimentos. Si bien esperabamos encontrar una disminución del porcentaje de tráfico Unicast durante la noche, lo mismo ocurrió solo en las redes 1 y 2, mientras que en las redes 3 y 4 subió. La única diferencia notable entre los experimentos diurnos y nocturnos fue la duración de los mismos: durante el día las capturas no tomaron más de 45 minutos (en algunos casos mucho menos), mientras que las nocturnas necesitaron varias horas para llegar a las 30.000 tramas capturadas.
...
(Fixme: se puede explicar algo del resto de los protocolos encontrados).
...
En la tabla \ref{table:desc_protocolos} se muestran las funciones de los protocolos encontrados. En la misma se puede ver cuales son de control y cuáles transportan datos del usuario.
