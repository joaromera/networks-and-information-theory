...
\begin{table}[]
    \begin{tabular}{llll}
    \multicolumn{4}{l}{Red 2 Jjunqueras}                \\
    Destino & Protocolo & Probabilidad & Información \\
    UNICAST     &    2048       &   0.99980      &   0.00029          \\
    UNICAST     &      2054     &    0.00020      &   12.28771          \\
    \multicolumn{4}{l}{Entropia 0.00275}
    \end{tabular}
\end{table}
...
\begin{table}[]
    ...
    \multicolumn{4}{l}{Entropia 0.11047}
    \end{tabular}
\end{table}
...
\begin{table}[]
    ...
    \multicolumn{4}{l}{Entropia 0.68719}
    \end{tabular}
\end{table}
...
\begin{table}[]
    ...
    \multicolumn{4}{l}{Entropia 0.97792}
    \end{tabular}
\end{table}
...
\begin{table}[]
    ...
    \multicolumn{4}{l}{Entropia 0.33152}
    \end{tabular}
\end{table}
...
\begin{table}[]
    ...
    \multicolumn{4}{l}{Entropia 0.03217}
    \end{tabular}
\end{table}
...
\begin{table}[]
    ...
    \multicolumn{4}{l}{Entropia 0.10100}
    \end{tabular}
\end{table}