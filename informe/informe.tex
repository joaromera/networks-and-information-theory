...
El objetivo del presente trabajo es utilizar técnicas provistas por la teoría de la información para estudiar los diversos protocolos de una red de manera analítica. Para esto se utilizará la biblioteca \textit{Scapy} con el fin de analizar el tráfico de distintas redes en distintas situaciones.

A continuación se detallan los experimentos que se van a realizar:
...
Se realizará en la red de cada uno de los integrantes del grupo.
...
Descripción de cada una de las 4 redes
